          ...
          <div className="steps21-container2">
            <div className="steps21-container3 thq-card">
              <h2>
                {props.step1Title ?? (
                  <Fragment>
                    <h2 className="steps21-text18 thq-heading-2">Step 1</h2>
                  </Fragment>
                )}
              </h2>
              <span>
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps21-text21 thq-body-small">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            ...
            <div className="steps21-container4 thq-card">
              <h2>
                {props.step2Title ?? (
                  <Fragment>
                    <h2 className="steps21-text19 thq-heading-2">Step 2</h2>
                  </Fragment>
                )}
              </h2>
              <span>
            ...
            <div className="steps21-container5 thq-card">
              <h2>
                {props.step3Title ?? (
                  <Fragment>
                    <h2 className="steps21-text16 thq-heading-2">Step 3</h2>
                  </Fragment>
                )}
              </h2>
              <span>
            ...
            <div className="steps21-container6 thq-card">
              <h2>
                {props.step4Title ?? (
                  <Fragment>
                    <h2 className="steps21-text22 thq-heading-2">Step 4</h2>
                  </Fragment>
                )}
              </h2>
              <span>
