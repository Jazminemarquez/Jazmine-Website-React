        ...
        <div className="contact10-content thq-flex-row">
          <div className="contact10-content1">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="contact10-text11 thq-heading-2">Locations</h2>
                </Fragment>
              )}
            </h2>
            <p>
        ...
        <div className="contact10-content2 thq-flex-row">
          <div className="contact10-container1">
            ...
            <h3>
              {props.location1 ?? (
                <Fragment>
                  <h3 className="contact10-text06 thq-heading-3">Bucharest</h3>
                </Fragment>
              )}
            </h3>
            <p>
...
Contact10.defaultProps = {
  location1: undefined,
  location1ImageSrc:
    'https://images.unsplash.com/photo-1630852722151-5ce82f3812a0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMzAxMjYzN3w&ixlib=rb-4.0.3&q=80&w=1080',
  location1ImageAlt: 'image1Alt',
  location2Description: undefined,
  location1Description: undefined,
  location2: undefined,
  location2ImageSrc:
    'https://images.unsplash.com/photo-1679168429289-dc560ad8d3fb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMzAxMjYzN3w&ixlib=rb-4.0.3&q=80&w=1080',
  content1: undefined,
