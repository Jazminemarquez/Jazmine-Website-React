        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="pricing14-text104 thq-heading-2">
                    Pricing plan
                  </h2>
                </Fragment>
              )}
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text055 thq-heading-3">
                          $20/mo
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text097 thq-body-large">
                          or $200 yearly
                        </p>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  <p>
                    {props.plan2 ?? (
                      <Fragment>
                        <p className="pricing14-text077 thq-body-large">
                          Business plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text078 thq-heading-3">
                          $29/mo
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  <p>
                    {props.plan3 ?? (
                      <Fragment>
                        <p className="pricing14-text070 thq-body-large">
                          Enterprise plan
                        </p>
                      </Fragment>
                    )}
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <Fragment>
                        <h3 className="pricing14-text072 thq-heading-3">
                          $49/mo
                        </h3>
                      </Fragment>
                    )}
                  ...
                  <p>
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <p className="pricing14-text080 thq-body-large">
                          or $499 yearly
                        </p>
                      </Fragment>
                    )}
                ...
                <div className="pricing14-list2">
                  <div className="pricing14-list-item07">
                    ...
                    <span>
                      {props.plan3Feature1 ?? (
                        <Fragment>
                          <span className="pricing14-text094 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  <span>
                    {props.plan11 ?? (
                      <Fragment>
                        <span className="pricing14-text098 thq-body-large">
                          Basic plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <div className="pricing14-list-item13">
                    ...
                    <span>
                      {props.plan1Feature21 ?? (
                        <Fragment>
                          <span className="pricing14-text107 thq-body-small">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text092 thq-heading-3">
                          $299/yr
                        </h3>
                      </Fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <h3 className="pricing14-text058 thq-heading-3">
                          $499/yr
                        </h3>
                      </Fragment>
                    )}
